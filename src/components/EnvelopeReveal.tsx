...
const BALLOON_PIECES: BalloonPieceConfig[] = [
  { left: "0%", color: GOLD, stagger: "0ms", drift: "16px", tilt: "6deg", scale: 1.3, duration: "4.6s" },
  { left: "10%", color: CREAM, stagger: "650ms", drift: "-14px", tilt: "-5deg", scale: 1.09, duration: "4.1s" },
  { left: "89%", color: ROSE_GOLD, stagger: "300ms", drift: "-16px", tilt: "-6deg", scale: 1.3, duration: "4.8s" },
  { left: "79%", color: BLUSH, stagger: "850ms", drift: "14px", tilt: "5deg", scale: 1.09, duration: "4.3s" },
];
